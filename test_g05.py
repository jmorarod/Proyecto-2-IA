...
def test_palabras_originadas():
    motor =  MotorLogico("etymwn.tsv", [] , [], False)
    motor.kb.append(Relation("eng", "nagware", "rel:is_derived_from", "eng", "nag"))
    motor.kb.append(Relation("eng", "nag", "rel:has_derived_form", "eng", "hamburger"))
    motor.kb.append(Relation("eng", "nag", "rel:has_derived_form", "eng", "hamburg"))
    motor.kb.append(Relation("eng", "hamburger", "rel:is_derived_from", "eng", "nag"))
    motor.kb.append(Relation("eng", "hamburg", "rel:is_derived_from", "eng", "nag"))
...
def test_idiomas_relacionados_palabra():
    motor =  MotorLogico("etymwn.tsv", [] , [], False)
    motor.kb.append(Relation("eng", "palabra", "rel:is_derived_from", "deu", "pal"))
    motor.kb.append(Relation("deu", "palabra", "rel:is_derived_from", "deu", "pa"))
    motor.kb.append(Relation("eng", "nagware", "rel:is_derived_from", "eng", "nag"))
    motor.kb.append(Relation("deu", "nagware", "rel:is_derived_from", "eng", "nag"))
    motor.kb.append(Relation("eng", "nag", "rel:has_derived_form", "deu", "hamburger"))
    motor.kb.append(Relation("eng", "nag", "rel:has_derived_form", "eng", "hamburg"))
    motor.kb.append(Relation("eng", "hamburger", "rel:is_derived_from", "eng", "nag"))
    motor.kb.append(Relation("eng", "hamburg", "rel:is_derived_from", "eng", "nag"))
...
def test_contador_palabras_comun():
    ...
    motor.kb.append(Relation("deu", "palabra", "rel:is_derived_from", "deu", "pa"))
    motor.kb.append(Relation("eng", "nagware", "rel:is_derived_from", "eng", "nag"))
    motor.kb.append(Relation("deu", "nagware", "rel:is_derived_from", "eng", "nagw"))
    motor.kb.append(Relation("eng", "nag", "rel:has_derived_form", "deu", "hambu"))
    motor.kb.append(Relation("eng", "na", "rel:has_derived_form", "eng", "hamburge"))
    motor.kb.append(Relation("eng", "hamburger", "rel:is_derived_from", "deu", "nag"))
    motor.kb.append(Relation("eng", "hamburg", "rel:is_derived_from", "eng", "ham"))
...
def test_palabras_comun_idiomas():
    ...
    motor.kb.append(Relation("eng", "hamburger", "rel:is_derived_from", "deu", "nag"))
    motor.kb.append(Relation("eng", "hamburg", "rel:is_derived_from", "eng", "ham"))
    motor.kb.append(Relation("eng", "hello", "rel:is_derived_from", "ita", "hola"))
...
def test_mayor_aporte_idioma():
    ...
    motor.kb.append(Relation("eng", "hamburger", "rel:is_derived_from", "deu", "nag"))
    motor.kb.append(Relation("eng", "hamburg", "rel:is_derived_from", "eng", "ham"))
    motor.kb.append(Relation("eng", "hello", "rel:is_derived_from", "fro", "hola"))
    motor.kb.append(Relation("eng", "bye", "rel:is_derived_from", "fro", "adios"))
    motor.kb.append(Relation("eng", "abc", "rel:is_derived_from", "fro", "asd"))
    motor.kb.append(Relation("eng", "dfe", "rel:is_derived_from", "fro", "zxc"))
...
def test_aporte_idiomas():
    ...
    assert resultado[1] == ['deu', 'fro'] and resultado[2] == [(0.42857142857142855, 0.5714285714285714)]
